...
class TestApi:
    ...
    @patch('plugins.utils.nicovideo_fetcher.NicovideoFetcher.fetch_playlist_and_latest_movie')
    def test_shoten_nicovideo(self, fetched_data):
        fetched_data.return_value = {
    ...
    @patch('plugins.utils.youtube_fetcher.YoutubeFetcher.fetch_playlist_and_latest_movie')
    def test_shoten_youtube(self, fetched_data):
        fetched_data.return_value = {
